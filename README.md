...
| 任务筛选与详情 | 勾选“运行中”快速筛选，也可在设置中按名称筛选；查看任务详情、复制任务 ID 或打开控制台 |
...
勾选“最近任务”右侧的“运行中”，即可查看所选平台中正在运行的任务；取消勾选后恢复显示所有状态。筛选先于最近 10 条的截取，较早启动的运行任务也能显示。应用记住勾选状态，任务通知仍按设置中的名称和资源范围监控。
